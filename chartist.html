...
<head>
    ...
    <link rel="stylesheet" href="styles/vendor_custom/chartist.css" />
...
<li><a href="mailbox_view.html">Mail View</a></li>
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li class="active"><a href="chartist.html">Chartist</a></li>
    ...
    <div >
        <div class="hpanel">
            <div class="panel-body">
                ...
                <small>Chartist.js is a simple responsive charting library built with SVG.</small>
            </div>
        </div>
    </div>
