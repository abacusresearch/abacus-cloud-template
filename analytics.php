...
<body class="fixed-navbar fixed-sidebar">
                            ...
                            <span class="font-bold no-margins">
                                Social users
                                    ...
                                    <div class="progress m-t-xs full progress-small">
                                        <div style="width: 55%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="55" role="progressbar" class=" progress-bar progress-bar-primary">
                                ...
                                <div class="m-t-xl">
                                    ...
                                    <div class="row m-t-sm">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="font-bold">98% <i class="fa fa-level-up text-primary"></i></div></div>
                            ...
                            <div class="panel-body h-200">
                                ...
                                <div class="m-t-xs">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <small class="stat-label">Today</small>
                                            <h4>$170,20 <i class="fa fa-level-up text-primary"></i></h4>
                                        </div>
                                        <div class="col-xs-6">
                                            <small class="stat-label">Last week</small>
                                            <h4>$580,90 <i class="fa fa-level-up text-primary"></i></h4>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-6">
                                            <small class="stat-label">Today</small>
                                            <h4>$620,20 <i class="fa fa-level-up text-primary"></i></h4>
                                        </div>
                                        <div class="col-xs-6">
                                            <small class="stat-label">Last week</small>
                                            <h4>$140,70 <i class="fa fa-level-up text-primary"></i></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-3">
                        <div class="hpanel stats">
                            <div class="panel-body h-200 list">
                                ...
                                <div class="progress m-t-xs full progress-small">
                                    <div style="width: 95%" aria-valuemax="100" aria-valuemin="0" aria-valuenow="95" role="progressbar" class=" progress-bar progress-bar-primary">
                                        <span class="sr-only">35% Complete (success)</span>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3">
                        <div class="hpanel">
                            <div class="panel-body text-center h-200">
                                ...
                                <h1 class="m-xs text-primary">$1 208,20</h1>
                                <small>Lorem ipsum dolor sit amet, consectetur adipiscing elit vestibulum consectetur adipiscing elit.</small>
                            </div>
                            <div class="panel-footer">
                                This is standard panel footer
    ...
    <script>
        ...
        $(function () {
             ...
             */
            var pieChartData = [
                { label: "Data 1", data: 16, color: "#1677cb", },
                { label: "Data 2", data: 6, color: "#c82200", },
                { label: "Data 3", data: 22, color: "#368410", },
                { label: "Data 4", data: 32, color: "#7877cb", }
            ];
